...
int main()
{
    ...
    User user = User(1, "user1", "password1", 30);
    RecommendationEngine recommendationEngine(new PopularityBasedStrategy(movieController));
    std::vector<Movie> recommendations = recommendationEngine.recommend(user, 5);
